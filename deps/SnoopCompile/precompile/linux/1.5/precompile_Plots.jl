...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(Base.Broadcast.instantiate),Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{2},Nothing,typeof(Plots.gr_color),Tuple{Array{RGBA{Float64},2}}}})
