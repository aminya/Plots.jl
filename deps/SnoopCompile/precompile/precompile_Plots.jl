...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),Dict{Symbol,Any},Type{Val{:contour}},Plot{PlotlyBackend}})
    ...
    Base.precompile(Tuple{typeof(frame),Animation,Plot{GRBackend}})
    ...
    Base.precompile(Tuple{typeof(make_steps),Array{Float64,1},Symbol})
